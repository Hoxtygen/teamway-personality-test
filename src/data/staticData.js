export const staticData = {
  header: {
    links: ["Home", "About", "Contact", "News"],
    cta: "Take the test",
    logo: "5Personalities",
    retake: "Retake the test",
  },
  content: {
    title: '"It\'s so incredible to finally be understood."',
    subtitle:
      'Take our Personality Test and get  "freakishly accurate" description of who you are and why you do things the way you do.',
    cta: "Take the Test",
    time: "Only takes 3 minutes",
  },
  footer: {
    links: ["Contact", "Testimonials", "Terms & Conditions", "Privacy Policy"],
    copyright: "Hoxtygen Integrated Ltd",
  },
  personality: {
    introvert: {
